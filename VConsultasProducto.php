...
<body onload="ini(); " onkeypress="parar();" onclick="parar();">
    <nav class="navbar navbar-dark bg-dark">
        <div class="container">
            <a style="margin: 0 auto;" href="#" class="navbar-brand">Buscar productos por:</a>
        </div>
    </nav>
                ...
                <table>
                    <tr>
                        <td>
                            <div class="row">
                                <div class="container">
                                    <button onclick="activarListaN();" class="btn btn-lg btn-block btn-primary">Nombre</button>
                ...
                <form class="form-group" action="#" method="post">
                    <div id="productos">
                        ...
                        <datalist id="nombresp">
                            ...
                            $query = "SELECT DISTINCT nombre FROM producto WHERE negocios_idnegocios ='$negocios' ORDER BY nombre ASC";
                            ...
                            while ($result = mysqli_fetch_array($row)) {
                                ...
                                <?php $datos = true;
                                echo "<option value='" . $result['nombre'] . "'> "; ?>
                            <?php
                            }
                            if ($datos == false) {
                    ...
                    <div id="codigos">
                        ...
                        <datalist id="codigosp">
                            ...
                            $datos = false;
                            $con = new Models\Conexion();
                            $query = "SELECT codigo_barras FROM producto WHERE negocios_idnegocios ='$negocios' ORDER BY codigo_barras ASC";
                            $row = $con->consultaListar($query);
                            $con->cerrarConexion();
                    ...
                    <div id="desc">
                        ...
                        <datalist id="descripcionp">
                            ...
                            $datos = false;
                            $con = new Models\Conexion();
                            $query = "SELECT DISTINCT descripcion FROM producto WHERE negocios_idnegocios ='$negocios' ORDER BY descripcion ASC";
                            $row = $con->consultaListar($query);
                            $con->cerrarConexion();
                    ...
                    <div id="marca">
                        ...
                        <datalist id="marcasp">
                            ...
                            $datos = false;
                            $con = new Models\Conexion();
                            $query = "SELECT DISTINCT marca FROM producto WHERE negocios_idnegocios ='$negocios' ORDER BY marca ASC";
                            $row = $con->consultaListar($query);
                            $con->cerrarConexion();
        ...
        <table class="table table-bordered">
            ...
            <tbody id="renglones">
                ...
                if (
                    ...
                    $marca =  $_POST['DlMarcasP'];
                    $tipo = $_POST['DlTipo'];
                    $estado = $_POST['DlEstado'];
                    $negocio = $_SESSION['idnegocio'];
                    $con = new Models\Conexion();

                    $query = "SELECT idproducto,producto.nombre,imagen,color,marca,descripcion,cantidad,unidad_medida,
                    talla_numero,precio_compra,precio_venta,codigo_barras,pestado,trabajador.nombre AS tnombre,apaterno
                    FROM producto INNER JOIN trabajador ON producto.trabajador_idtrabajador=trabajador.idtrabajador
                    WHERE producto.nombre = '$nombre' AND producto.negocios_idnegocios ='$negocio'
                                            OR codigo_barras = '$codigo' AND producto.negocios_idnegocios ='$negocio' 
                                            OR descripcion = '$descripcion' AND producto.negocios_idnegocios ='$negocio'
                                            OR marca='$marca' AND producto.negocios_idnegocios ='$negocio'
                                            OR tipo='$tipo' AND producto.negocios_idnegocios ='$negocio'
                                            OR pestado='$estado' AND producto.negocios_idnegocios ='$negocio'";
