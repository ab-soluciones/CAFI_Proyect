        ...
        <div class="collapse navbar-collapse col-9 d-flex justify-content-center align-items-center" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item mx-2 text-center">
                    <a id="orange" class="nav-link font-weight-bold" onclick="window.location.href='VUsuarios_ab.php'" title="Venta"><img src="img/usuarios.png">Usuarios</a>
                </li>
                <li class="nav-item mx-2 text-center">
                    <a class="nav-link font-weight-bold" onclick="window.location.href='VClienteab.php'" title="Abonos"><img src="img/clientes.png">Clientes</a>
                </li>
                <li class="nav-item mx-2 text-center">
                    <a class="nav-link font-weight-bold" onclick="window.location.href='VNegociosab.php'" title="Adeudos"><img src="img/negocios.png">Negocios</a>
                </li>
                <li class="nav-item mx-2 text-center">
                    <a id="orange" class="nav-link font-weight-bold" onclick="window.location.href='VSuscripcion.php'" title="Gastos"><img src="img/agenda.png">Suscripciones</a>
                </li>
            </ul>
        </div>
