                ...
                <form class="form-group" action="#" method="post">
                    <div id="productos">
                        ...
                        <datalist id="lproductos">
                            ...
                            $datos = false;
                            $query = "SELECT nombre,color,marca,talla_numero FROM producto WHERE negocios_idnegocios ='$negocios' AND pestado = 'A' ORDER BY nombre ASC";
                    ...
                    <div id="codigos">
                        ...
                        <datalist id="codigosp">
                            ...
                            $negocios = $_SESSION['idnegocio'];
                            $datos = false;
                            $query = "SELECT codigo_barras FROM producto WHERE negocios_idnegocios ='$negocios' AND pestado = 'A'  ORDER BY codigo_barras ASC";
                            $row = $con->consultaListar($query);
                    ...
                    <div id="desc">
                        ...
                        <datalist id="descripcionp">
                            ...
                            $negocios = $_SESSION['idnegocio'];
                            $datos = false;
                            $query = "SELECT descripcion FROM producto WHERE negocios_idnegocios ='$negocios' AND pestado = 'A' ORDER BY descripcion ASC";
                            $row = $con->consultaListar($query);
            ...
            <table class="table table-bordered table-responsive-md">
                <form action="#" method="post">
                    ...
                    <tbody id="renglones">
                        ...
                        $idventa = (int) $_SESSION['idven'];
                        $query = "SELECT nombre,imagen,color,marca,unidad_medida,talla_numero,descripcion,precio_venta, cantidad,cantidad_producto,iddetalle_venta,subtotal FROM
