            ...
            <div class="col-md-8" style=" margin: 0 auto; margin-top:15px;">
                <table class="table table-bordered table-responsive-md">
                    <tr>
                        ...
                        $query = "SELECT  nombre,imagen,marca,color,talla_numero,unidad_medida,cantidad,COUNT(*) AS 
                        repetido FROM producto WHERE tipo='$tipo' AND producto.negocios_idnegocios='$negocio' GROUP BY nombre,color,talla_numero";
                ...
                <?php } else if (isset($_POST['STipo']) && $_POST['STipo'] === "Calzado") {
                    ...
                    <div class="col-xl-12" style=" margin: 0 auto; margin-top:15px;">
                        <table class="table table-bordered table-responsive-xl">
                            ...
                            $negocio = $_SESSION['idnegocio'];
                            $con = new Models\Conexion();
                            $query = "SELECT  nombre,imagen,marca,color,unidad_medida,talla_numero,cantidad,COUNT(*) AS 
                            repetido FROM producto WHERE tipo='$tipo'AND producto.negocios_idnegocios='$negocio' GROUP BY nombre,color,talla_numero";
                            $row = $con->consultaListar($query);
                            $con->cerrarConexion();
                            $nombretemporal = "";
