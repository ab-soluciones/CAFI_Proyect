        ...
        <div id="botones" class="row" style="margin-top: 5px;">
            <div class="col-md-3" style="margin: 0 auto;">
                <div class="card card-body">
                    ...
                    <button onclick="aD();" class="btn btn-lg btn-block btn-info">Descripcion</button>
                </div>
            </div>
        </div>
                    ...
                    <form class="form-group" action="#" method="post">
                        <div id="productos">
                            ...
                            <datalist id="nombresp">
                                ...
                                $query = "SELECT nombre,marca,color,talla_numero FROM producto WHERE negocios_idnegocios ='$negocio' ORDER BY nombre ASC";
                ...
                <table class="table table-bordered">
                    ...
                    <tbody id="renglones">
                        ...
                        if (
                            ...
                            producto.color, ' talla ', producto.talla_numero))='$nombre' AND producto.negocios_idnegocios ='$negocio' 
