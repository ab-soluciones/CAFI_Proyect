...
if (!isset($_SESSION['acceso'])) {
    ...
    if (isset($_GET['id'])) {
        ...
        $query =  $sql = "SELECT nombre_negocio,domicilio,ciudad,telefono_negocio,nombre,apaterno,amaterno FROM negocios
    ...
    if (
        ...
        && isset($_POST['TCiudad']) && isset($_POST['DlClientes'])  && isset($_POST['TTelefono'])
    ) {
