                    ...
                    <form class="form-group" id="formuusers">
                        ...
                        <div class="d-block d-lg-flex row">
                            <div class="col-lg-12">
                                ...
                                <div class="row" style="margin: 0 auto;" >
                                    <select id="estadousers" class="form form-control">
          ...
          <div class="col-lg-12">
            <div id="tableContainer" class="d-block col-lg-12">
                  <div class="input-group mb-2">
                      <button  class="d-lg-none btn btn-primary col-12 mb-3 p-3 clearForm" data-toggle="modal" data-target="#modalForm">Agregar</button>
                      <div class="input-group-prepend">
                      <div class="input-group-text"><i class="fa fa-search"></i></div>
                      </div>
                      <input class="form-control col-12 col-lg-4" type="text" id="busqueda" onkeyup="busqueda()" placeholder="Buscar..." title="Type in a name" value="">
                      <button   class="d-none d-lg-flex btn btn-primary ml-3 clearForm" data-toggle="modal" data-target="#modalForm">Agregar</button>
                  </div>
