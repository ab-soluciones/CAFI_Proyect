                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="Inventario" role="tabpanel" aria-labelledby="Inventario-tab">
                                    <div class="col-12">
                                        <br>
                                        <form action="#" method="post">
                                            <h5 class="general">Negocio:</label></h5>
                                            <select class="form form-control" name="SSucursal">
                                                <option></option>
                                                <?php
                                                $con = new Models\Conexion();
    ...
    <div class="contenedor container-fluid">
        <div id="tableContainer" class="d-block col-lg-12">
            <div class="input-group mb-2">
                ...
                <button class="btn btn-primary ml-4" data-toggle="modal" data-target="#modalForm">Filtrar</button>
                
                <form action="#" method="post">
                    <button name="BSucursales" type="submit" class="btn btn-danger ml-4">Estado de todas las sucursales</button>
                </form>
            </div>
